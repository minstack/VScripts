...
class VendApi:
    ...
    __ENDPOINTS = {
        ...
        "prodimages" : "api/2.0/product_images"
    }
    ...
    def deleteProdImage(self, id):
        url = f"{self.__domain}{self.__ENDPOINTS['prodimages']}/{id}"
    ...
    def uploadImage(self, pid, image):
        ...
        url = f"{self.__domain}{self.__ENDPOINTS['products2.0']}/{pid}/actions/image_upload"
        payload = {
            'image' : image
        }
